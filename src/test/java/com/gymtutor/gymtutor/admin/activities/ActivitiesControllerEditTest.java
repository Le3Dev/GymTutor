...
class ActivitiesControllerEditTest {
    ...
    void ct01() throws Exception {
        doNothing().when(activitiesService).updateActivity(any(), any(Integer.class));

        mockMvc.perform(post("/admin/activities/{activitiesId}/edit", ACTIVITY_ID)
                ...
                .andExpect(flash().attribute("successMessage", "Atividade alterada com sucesso!!!"));
    }
