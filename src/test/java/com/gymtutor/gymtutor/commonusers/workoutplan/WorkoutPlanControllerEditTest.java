...
class WorkoutPlanControllerEditTest {

    private static final int WORKOUTPLAN_ID = 1;
    ...
    void ct01() throws Exception {
        doNothing().when(workoutPlanService).updateWorkoutPlan(any(), any(Integer.class));

        mockMvc.perform(post("/student/workoutplan/{workoutPlanId}/edit", WORKOUTPLAN_ID)
                ...
                .andExpect(flash().attribute("successMessage", "Ficha de treino alterada com sucesso!"));
    }
